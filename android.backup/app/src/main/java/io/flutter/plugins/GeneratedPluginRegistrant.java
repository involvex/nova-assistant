...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new dev.flutterberlin.flutter_gemma_mediapipe.FlutterGemmaMediaPipePlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_gemma_mediapipe, dev.flutterberlin.flutter_gemma_mediapipe.FlutterGemmaMediaPipePlugin", e);
    }
    try {
